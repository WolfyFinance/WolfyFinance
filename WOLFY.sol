...
contract Wolfy is ERC20, Ownable {
    ...
    address payable _marketingWallet = payable(address(0x2c71d28Ee7DeD1c469CcAA78F8EeD2cf45C1653f)); // MarketingWallet
    ...
    constructor() ERC20("Wolfy Finance", "WOLFY") {
